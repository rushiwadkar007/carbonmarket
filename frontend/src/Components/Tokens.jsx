...
export default function Tokens(){
    ...
    return (
        <>
        <div className="text-2xl text-center font-semibold">CARBON MARKETPLACE</div>
                    ...
                    return (
                        <tr className="border-b border-gray-200 hover:bg-gray-50" key={index}>
                            ...
                            <td className="py-3 px-6 text-center">
                                ...
                                }} className="bg-sky-600 hover:bg-green-500 text-white font-semibold py-2 px-4 rounded-full">
                                    Buy
                                </button>
                            </td>
                        </tr>
